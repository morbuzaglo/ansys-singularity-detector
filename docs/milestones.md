...
| 5 | Secondary metrics | next | Nodal-difference / elemental-nodal disagreement, discretisation-error indicator, hotspot-radius shrink, geometry/BC priors, global-solution sanity gate (spec §28–32). Feed the Confidence score (M6). |
