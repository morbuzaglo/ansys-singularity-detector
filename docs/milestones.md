...
| 7 | Custom Mechanical contours | next | Two DPF-backed custom results in the Mechanical tree: **Singularity Confidence [%]** (0–100 from `confidence_field.npz`) and **Singularity-Filtered Stress** (raw finest-mesh σ where confidence < 70, recovered neighbourhood estimate where ≥ 70; spec §35–38). Also **Raw Stress — Original FE Solution** untouched. |
