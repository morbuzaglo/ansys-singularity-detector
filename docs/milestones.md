...
| 6 | Confidence score | next | Combine: 55% mesh divergence (M4 `singularity_evidence`) + 20% S28 + 10% S29 + 15% S31, then × S32 gate. Categories 0–39 / 40–69 / 70–89 / 90–100. Region clustering. Calibrate weights on the benchmarks (spec §33). |
